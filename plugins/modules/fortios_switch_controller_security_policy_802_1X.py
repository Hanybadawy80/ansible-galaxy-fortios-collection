...
def filter_switch_controller_security_policy_802_1X_data(json):
    option_list = ['auth_fail_vlan', 'auth_fail_vlan_id', 'eap_auto_untagged_vlans',
                   'eap_passthru', 'framevid_apply', 'guest_auth_delay',
                   'guest_vlan', 'guest_vlan_id', 'mac_auth_bypass',
    ...
    fields = {
        ...
        "switch_controller_security_policy_802_1X": {
            ...
            "options": {
                ...
                "eap_auto_untagged_vlans": {"required": False, "type": "str",
                                            "choices": ["disable",
                                                        "enable"]},
