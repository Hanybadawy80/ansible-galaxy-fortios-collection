...
def switch_controller_port_policy(data, fos):
    vdom = data['vdom']
    state = data['state']
...
def fortios_switch_controller(data, fos):
    ...
    if data['switch_controller_port_policy']:
        resp = switch_controller_port_policy(data, fos)
...
def main():
    fields = {
        ...
        "switch_controller_port_policy": {
            ...
            "options": {
                "802_1x": {"required": False, "type": "str"},
                "bounce_port_link": {"required": False, "type": "str",
                                     "choices": ["disable",
                                                 "enable"]},
                ...
                "vlan_policy": {"required": False, "type": "str"}
