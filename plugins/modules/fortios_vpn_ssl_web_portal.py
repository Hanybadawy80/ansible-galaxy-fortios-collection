...
def filter_vpn_ssl_web_portal_data(json):
    option_list = ['allow_user_access', 'auto_connect', 'bookmark_group',
                   ...
                   'redir_url', 'save_password', 'service_restriction',
                   'skip_check_for_browser', 'skip_check_for_unsupported_os', 'smb_max_version',
                   'smb_min_version', 'smb_ntlmv1_auth', 'smbv1',
                   'split_dns', 'split_tunneling', 'split_tunneling_routing_address',
                   'split_tunneling_routing_negate', 'theme', 'tunnel_mode',
    ...
    fields = {
        ...
        "vpn_ssl_web_portal": {
            ...
            "options": {
                ...
                "ipv6_split_tunneling_routing_negate": {"required": False, "type": "str",
                                                        "choices": ["enable",
                                                                    "disable"]},
                ...
                "split_tunneling_routing_negate": {"required": False, "type": "str",
                                                   "choices": ["enable",
                                                               "disable"]},
