...
def filter_system_csf_data(json):
    option_list = ['configuration_sync', 'fabric_device', 'fabric_object_unification',
        ...
        "system_csf": {
            ...
            "options": {
                ...
                "fabric_device": {"required": False, "type": "list",
                                  "options": {
                                      "access_token": {"required": False, "type": "varlen_password"},
                                      "device_ip": {"required": False, "type": "str"},
                                      "https_port": {"required": False, "type": "int"},
                                      "name": {"required": True, "type": "str"}
                                  }},
                "fabric_object_unification": {"required": False, "type": "str",
                                              "choices": ["default",
                                                          "local"]},
