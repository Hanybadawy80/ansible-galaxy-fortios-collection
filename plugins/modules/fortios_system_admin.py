...
def filter_system_admin_data(json):
    option_list = ['accprofile', 'accprofile_override', 'allow_remove_admin_session',
                   ...
                   'guest_usergroups', 'ip6_trusthost1', 'ip6_trusthost10',
                   'ip6_trusthost2', 'ip6_trusthost3', 'ip6_trusthost4',
                   'ip6_trusthost5', 'ip6_trusthost6', 'ip6_trusthost7',
                   'ip6_trusthost8', 'ip6_trusthost9', 'name',
                   'password', 'password_expire', 'peer_auth',
                   'peer_group', 'radius_vdom_override', 'remote_auth',
                   'remote_group', 'schedule', 'sms_custom_server',
                   'sms_phone', 'sms_server', 'ssh_certificate',
                   'ssh_public_key1', 'ssh_public_key2', 'ssh_public_key3',
                   'trusthost1', 'trusthost10', 'trusthost2',
                   'trusthost3', 'trusthost4', 'trusthost5',
                   'trusthost6', 'trusthost7', 'trusthost8',
                   'trusthost9', 'two_factor', 'two_factor_authentication',
                   'two_factor_notification', 'vdom', 'wildcard']
    dictionary = {}
            ...
            "options": {
                ...
                "two_factor": {"required": False, "type": "str",
                               "choices": ["disable",
                                           ...
                                           "email",
                                           "sms"]},
                "two_factor_authentication": {"required": False, "type": "str",
                                              "choices": ["fortitoken",
                                                          "email",
                                                          "sms"]},
                "two_factor_notification": {"required": False, "type": "str",
                                            "choices": ["email",
                                                        "sms"]},
