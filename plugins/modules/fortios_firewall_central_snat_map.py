...
def filter_firewall_central_snat_map_data(json):
    option_list = ['comments', 'dst_addr', 'dst_addr6',
                   ...
                   'nat_ippool6', 'nat_port', 'orig_addr',
                   'orig_addr6', 'orig_port', 'policyid',
    ...
    fields = {
        ...
        "firewall_central_snat_map": {
            ...
            "options": {
                ...
                "dst_addr6": {"required": False, "type": "list",
                              "options": {
                                  "name": {"required": True, "type": "str"}
                              }},
                ...
                "nat_ippool6": {"required": False, "type": "list",
                                "options": {
                                    "name": {"required": True, "type": "str"}
                                }},
                ...
                "orig_addr6": {"required": False, "type": "list",
                               "options": {
                                   "name": {"required": True, "type": "str"}
                               }},
