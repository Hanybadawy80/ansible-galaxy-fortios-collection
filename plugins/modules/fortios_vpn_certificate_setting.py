...
def filter_vpn_certificate_setting_data(json):
    option_list = ['certname_dsa1024', 'certname_dsa2048', 'certname_ecdsa256',
                   ...
                   'cmp_save_extra_certs', 'cn_match', 'ocsp_default_server',
                   'ocsp_option', 'ocsp_status', 'ssl_min_proto_version',
                   'ssl_ocsp_source_ip', 'strict_crl_check', 'strict_ocsp_check',
                   'subject_match']
    dictionary = {}
    ...
    fields = {
        ...
        "vpn_certificate_setting": {
            ...
            "options": {
                ...
                "certname_ecdsa521": {"required": False, "type": "str"},
                "certname_ed25519": {"required": False, "type": "str"},
                "certname_ed448": {"required": False, "type": "str"},
                "certname_rsa1024": {"required": False, "type": "str"},
                "certname_rsa2048": {"required": False, "type": "str"},
                "certname_rsa4096": {"required": False, "type": "str"},
                ...
                "ssl_min_proto_version": {"required": False, "type": "str",
                                          "choices": ["default",
                                                      ...
                                                      "TLSv1-1",
                                                      "TLSv1-2"]},
                "ssl_ocsp_source_ip": {"required": False, "type": "str"},
