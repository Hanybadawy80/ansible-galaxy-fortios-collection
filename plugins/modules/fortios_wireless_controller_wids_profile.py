...
options:
    ...
    wireless_controller_wids_profile:
        ...
        suboptions:
            ...
            ap_bgscan_period:
                description:
                    - Period of time between background scans (10 - 3600 sec).
                type: int
...
def filter_wireless_controller_wids_profile_data(json):
    option_list = ['ap_auto_suppress', 'ap_bgscan_disable_schedules', 'ap_bgscan_duration',
        ...
        "wireless_controller_wids_profile": {
            ...
            "options": {
                ...
                "ap_auto_suppress": {"required": False, "type": "str",
                                     "choices": ["enable",
                                                 "disable"]},
                "ap_bgscan_disable_schedules": {"required": False, "type": "list",
                                                "options": {
                ...
                "ap_scan_passive": {"required": False, "type": "str",
                                    "choices": ["enable",
                                                "disable"]},
                "ap_scan_threshold": {"required": False, "type": "str"},
