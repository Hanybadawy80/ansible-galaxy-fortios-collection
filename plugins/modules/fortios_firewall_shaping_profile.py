        ...
        "firewall_shaping_profile": {
            ...
            "options": {
                ...
                "shaping_entries": {"required": False, "type": "list",
                                    "options": {
                                        "burst_in_msec": {"required": False, "type": "int"},
                                        "cburst_in_msec": {"required": False, "type": "int"},
                                        ...
                                        "max": {"required": False, "type": "int"},
                                        "maximum_bandwidth_percentage": {"required": False, "type": "int"},
                                        "min": {"required": False, "type": "int"},
                                        "priority": {"required": False, "type": "str",
                                                     "choices": ["top",
                                                                 ...
                                                                 "medium",
                                                                 "low"]},
                                        "red_probability": {"required": False, "type": "int"}
                                    }},
