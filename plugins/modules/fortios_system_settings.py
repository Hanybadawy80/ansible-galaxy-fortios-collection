...
def filter_system_settings_data(json):
    option_list = ['allow_linkdown_path', 'allow_subnet_overlap', 'asymroute',
                   ...
                   'auxiliary_session', 'bfd', 'bfd_desired_min_tx',
                   'bfd_detect_mult', 'bfd_dont_enforce_src_port', 'bfd_required_min_rx',
                   'block_land_attack', 'central_nat', 'comments',
                   ...
                   'gui_policy_disclaimer', 'gui_replacement_message_groups', 'gui_spamfilter',
                   ...
                   'ike_quick_crash_detect', 'ike_session_resume', 'ip',
                   'ip6', 'link_down_access', 'lldp_reception',
                   'lldp_transmission', 'mac_ttl', 'manageip',
                   'manageip6', 'multicast_forward', 'multicast_skip_policy',
                   'multicast_ttl_notchange', 'ngfw_mode', 'opmode',
                   'prp_trailer_action', 'sccp_port', 'sctp_session_without_init',
                   'ses_denied_traffic', 'sip_expectation', 'sip_nat_trace',
                   'sip_ssl_port', 'sip_tcp_port', 'sip_udp_port',
                   'snat_hairpin_traffic', 'status', 'strict_src_check',
                   'tcp_session_without_syn', 'utf8_spam_tagging', 'v4_ecmp_mode',
                   'vpn_stats_log', 'vpn_stats_period', 'wccp_cache_engine']
    dictionary = {}
        ...
        "system_settings": {
            ...
            "options": {
                ...
                "asymroute6_icmp": {"required": False, "type": "str",
                                    "choices": ["enable",
                                                "disable"]},
                "auxiliary_session": {"required": False, "type": "str",
                                      "choices": ["enable",
                                                  "disable"]},
                ...
                "gui_policy_based_ipsec": {"required": False, "type": "str",
                                           "choices": ["enable",
                                                       "disable"]},
                "gui_policy_disclaimer": {"required": False, "type": "str",
                                          "choices": ["enable",
                                                      "disable"]},
                ...
                "ses_denied_traffic": {"required": False, "type": "str",
                                       "choices": ["enable",
                                                   "disable"]},
                "sip_expectation": {"required": False, "type": "str",
                                    "choices": ["enable",
                                                "disable"]},
