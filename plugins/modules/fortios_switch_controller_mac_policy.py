...
options:
    ...
    switch_controller_mac_policy:
        ...
        suboptions:
            ...
            vlan:
                description:
                    - VLAN to be applied when using this MAC policy. Source system.interface.name.
                type: str
'''
...
def filter_switch_controller_mac_policy_data(json):
    option_list = ['count', 'description', 'drop',
                   'fortilink', 'name', 'traffic_policy',
                   'vlan']
    dictionary = {}
...
def switch_controller_mac_policy(data, fos):
    vdom = data['vdom']
    state = data['state']
...
def fortios_switch_controller(data, fos):
    ...
    if data['switch_controller_mac_policy']:
        resp = switch_controller_mac_policy(data, fos)
