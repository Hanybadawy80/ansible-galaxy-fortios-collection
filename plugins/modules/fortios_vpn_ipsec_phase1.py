...
def filter_vpn_ipsec_phase1_data(json):
    option_list = ['acct_verify', 'add_gw_route', 'add_route',
                   ...
                   'fec_base', 'fec_egress', 'fec_ingress',
                   'fec_receive_timeout', 'fec_redundant', 'fec_send_timeout',
                   ...
                   'suite_b', 'type', 'unity_support',
                   'usrgrp', 'wizard_type', 'xauthtype']
    dictionary = {}
