...
def filter_wireless_controller_wtp_data(json):
    option_list = ['admin', 'allowaccess', 'apcfg_profile',
                   'bonjour_profile', 'coordinate_latitude', 'coordinate_longitude',
            ...
            "options": {
                ...
                "allowaccess": {"required": False, "type": "str",
                                "choices": ["https",
                                            "ssh",
                                            "snmp"]},
                "apcfg_profile": {"required": False, "type": "str"},
                ...
                "radio_3": {"required": False, "type": "dict",
                            "options": {
                                "auto_power_high": {"required": False, "type": "int"},
                                "auto_power_level": {"required": False, "type": "str",
                                                     "choices": ["enable",
                ...
                "radio_4": {"required": False, "type": "dict",
                            "options": {
                                "auto_power_high": {"required": False, "type": "int"},
                                "auto_power_level": {"required": False, "type": "str",
                                                     "choices": ["enable",
