            ...
            "options": {
                ...
                "area": {"required": False, "type": "list",
                         "options": {
                             ...
                             "ipsec_auth_alg": {"required": False, "type": "str",
                                                "choices": ["md5",
                                                            "sha1",
                                                            "sha256",
                                                            "sha384",
                                                            "sha512"]},
                             "ipsec_enc_alg": {"required": False, "type": "str",
                                               "choices": ["null",
                                                           "des",
                                                           "3des",
                                                           "aes128",
                                                           "aes192",
                                                           "aes256"]},
                             "ipsec_keys": {"required": False, "type": "list",
                                            "options": {
                                                "auth_key": {"required": False, "type": "str"},
                                                "enc_key": {"required": False, "type": "str"},
                                                "spi": {"required": True, "type": "int"}
                                            }},
                             "key_rollover_interval": {"required": False, "type": "int"},
