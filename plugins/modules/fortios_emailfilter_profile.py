...
def filter_emailfilter_profile_data(json):
    option_list = ['comment', 'external', 'feature_set',
                   ...
                   'options', 'pop3', 'replacemsg_group',
                   'smtp', 'spam_bwl_table', 'spam_bword_table',
                   'spam_bword_threshold', 'spam_filtering', 'spam_iptrust_table',
                   'spam_log', 'spam_log_fortiguard_response', 'spam_mheader_table',
