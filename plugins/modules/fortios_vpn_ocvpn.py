...
def filter_vpn_ocvpn_data(json):
    option_list = ['auto_discovery', 'eap', 'eap_users',
                   'forticlient_access', 'ip_allocation_block', 'multipath',
                   'nat', 'overlays', 'poll_interval',
                   'role', 'sdwan', 'status',
                   'wan_interface']
    dictionary = {}
        ...
        "vpn_ocvpn": {
            ...
            "options": {
                ...
                "eap": {"required": False, "type": "str",
                        "choices": ["enable",
                                    "disable"]},
                "eap_users": {"required": False, "type": "str"},
                "forticlient_access": {"required": False, "type": "dict",
                                       "options": {
                                           "auth_groups": {"required": False, "type": "list",
                                                           "options": {
                                                               "auth_group": {"required": False, "type": "str"},
                                                               "name": {"required": True, "type": "str"},
                                                               "overlays": {"required": False, "type": "list",
                                                                            "options": {
                                                                                "overlay_name": {"required": False, "type": "str"}
                                                                            }}
                                                           }},
                ...
                "ip_allocation_block": {"required": False, "type": "str"},
                "multipath": {"required": False, "type": "str",
                              "choices": ["enable",
                                          "disable"]},
                ...
                "role": {"required": False, "type": "str",
                         "choices": ["spoke",
                                     "primary-hub",
                                     "secondary-hub"]},
                "sdwan": {"required": False, "type": "str",
                          "choices": ["enable",
                                      "disable"]},
                "status": {"required": False, "type": "str",
                           "choices": ["enable",
                                       "disable"]},
                "wan_interface": {"required": False, "type": "list",
                                  "options": {
                                      "name": {"required": True, "type": "str"}
                                  }}
