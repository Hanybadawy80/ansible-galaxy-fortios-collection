...
options:
    ...
    system_ha:
        ...
        suboptions:
            ...
            group_id:
                description:
                    - HA group ID  (0 - 255). Must be the same for all members.
                type: int
            group_name:
                description:
...
def filter_system_ha_data(json):
    option_list = ['arps', 'arps_interval', 'authentication',
                   ...
                   'load_balance_all', 'logical_sn', 'memory_compatible_mode',
                   ...
                   'sync_packet_balance', 'unicast_hb', 'unicast_hb_netmask',
                   'unicast_hb_peerip', 'uninterruptible_upgrade', 'vcluster_id',
                   'vcluster2', 'vdom', 'weight']
    dictionary = {}
