...
def main():
    fields = {
        ...
        "system_saml": {
            ...
            "options": {
                "artifact_resolution_url": {"required": False, "type": "str"},
                "binding_protocol": {"required": False, "type": "str",
                                     "choices": ["post"]},
                ...
                "idp_artifact_resolution_url": {"required": False, "type": "str"},
                ...
                "service_providers": {"required": False, "type": "list",
                                      "options": {
                                          ...
                                          "sp_artifact_resolution_url": {"required": False, "type": "str"},
                                          "sp_binding_protocol": {"required": False, "type": "str",
                                                                  "choices": ["post"]},
