...
def wireless_controller_apcfg_profile(data, fos):
    vdom = data['vdom']
    state = data['state']
...
def fortios_wireless_controller(data, fos):
    ...
    if data['wireless_controller_apcfg_profile']:
        resp = wireless_controller_apcfg_profile(data, fos)
...
def main():
    fields = {
        ...
        "wireless_controller_apcfg_profile": {
            ...
            "options": {
                "ac_ip": {"required": False, "type": "str"},
                "ac_port": {"required": False, "type": "int"},
                "ac_timer": {"required": False, "type": "int"},
                "ac_type": {"required": False, "type": "str",
                            "choices": ["default",
                                        "specify",
                                        "apcfg"]},
                "command_list": {"required": False, "type": "list",
                                 "options": {
                                     "id": {"required": True, "type": "int"},
                                     "name": {"required": False, "type": "str"},
                                     "passwd_value": {"required": False, "type": "str"},
                                     "type": {"required": False, "type": "str",
                                              "choices": ["non-password",
                                                          "password"]},
