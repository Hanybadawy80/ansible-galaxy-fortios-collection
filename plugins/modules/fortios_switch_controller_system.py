...
options:
    ...
    switch_controller_system:
        ...
        suboptions:
            ...
            iot_holdoff:
                description:
                    - MAC entry"s creation time. Time must be greater than this value for an entry to be created .
                type: int
            iot_mac_idle:
                description:
...
def filter_switch_controller_system_data(json):
    option_list = ['data_sync_interval', 'iot_holdoff', 'iot_mac_idle',
                   'iot_scan_interval', 'iot_weight_threshold', 'parallel_process',
                   'parallel_process_override']
    dictionary = {}
...
def main():
    fields = {
        ...
        "switch_controller_system": {
            ...
            "options": {
                "data_sync_interval": {"required": False, "type": "int"},
                "iot_holdoff": {"required": False, "type": "int"},
                "iot_mac_idle": {"required": False, "type": "int"},
                "iot_scan_interval": {"required": False, "type": "int"},
                "iot_weight_threshold": {"required": False, "type": "int"},
