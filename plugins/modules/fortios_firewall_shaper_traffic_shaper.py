    ...
    fields = {
        ...
        "firewall_shaper_traffic_shaper": {
            ...
            "options": {
                ...
                "dscp_marking_method": {"required": False, "type": "str",
                                        "choices": ["multi-stage",
                                                    "static"]},
                "exceed_bandwidth": {"required": False, "type": "int"},
                "exceed_class_id": {"required": False, "type": "int"},
                "exceed_dscp": {"required": False, "type": "str"},
                "guaranteed_bandwidth": {"required": False, "type": "int"},
                "maximum_bandwidth": {"required": False, "type": "int"},
                "maximum_dscp": {"required": False, "type": "str"},
                "name": {"required": True, "type": "str"},
                "overhead": {"required": False, "type": "int"},
