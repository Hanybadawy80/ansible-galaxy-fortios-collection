...
def filter_firewall_proxy_policy_data(json):
    option_list = ['action', 'application_list', 'av_profile',
                   'cifs_profile', 'comments', 'decrypted_traffic_mirror',
                   'disclaimer', 'dlp_sensor', 'dstaddr',
                   'dstaddr_negate', 'dstaddr6', 'dstintf',
                   'emailfilter_profile', 'groups', 'http_tunnel_auth',
                   ...
                   'internet_service_negate', 'ips_sensor', 'logtraffic',
