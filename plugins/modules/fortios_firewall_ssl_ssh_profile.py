...
def filter_firewall_ssl_ssh_profile_data(json):
    option_list = ['block_blacklisted_certificates', 'caname', 'comment',
                   ...
                   'ssl_negotiation_log', 'ssl_server', 'untrusted_caname',
        ...
        "firewall_ssl_ssh_profile": {
            ...
            "options": {
                ...
                "ftps": {"required": False, "type": "dict",
                         "options": {
                             "cert_validation_failure": {"required": False, "type": "str",
                                                         "choices": ["allow",
                                                                     "block",
                                                                     "ignore"]},
                             "cert_validation_timeout": {"required": False, "type": "str",
                                                         "choices": ["allow",
                                                                     "block",
                                                                     "ignore"]},
                             "client_certificate": {"required": False, "type": "str",
                                                    "choices": ["bypass",
                                                                "inspect",
                                                                "block"]},
                             "expired_server_cert": {"required": False, "type": "str",
                                                     "choices": ["allow",
                                                                 "block",
                                                                 "ignore"]},
                             "ports": {"required": False, "type": "int"},
                             "revoked_server_cert": {"required": False, "type": "str",
                                                     "choices": ["allow",
                                                                 "block",
                                                                 "ignore"]},
                             ...
                             "status": {"required": False, "type": "str",
                                        "choices": ["disable",
                                                    "deep-inspection"]},
                             "unsupported_ssl_cipher": {"required": False, "type": "str",
                                                        "choices": ["allow",
                                                                    "block"]},
                             "unsupported_ssl_negotiation": {"required": False, "type": "str",
                                                             "choices": ["allow",
                                                                         "block"]},
                ...
                "ssl_exemptions_log": {"required": False, "type": "str",
                                       "choices": ["disable",
                                                   "enable"]},
                "ssl_negotiation_log": {"required": False, "type": "str",
                                        "choices": ["disable",
                                                    "enable"]},
                "ssl_server": {"required": False, "type": "list",
                               "options": {
                                   "ftps_client_certificate": {"required": False, "type": "str",
                                                               "choices": ["bypass",
                                                                           "inspect",
                                                                           "block"]},
                                   "https_client_certificate": {"required": False, "type": "str",
                                                                "choices": ["bypass",
                                                                            "inspect",
                                                                            "block"]},
                                   "id": {"required": True, "type": "int"},
                                   "imaps_client_certificate": {"required": False, "type": "str",
                                                                "choices": ["bypass",
                                                                            "inspect",
                                                                            "block"]},
                                   "ip": {"required": False, "type": "str"},
                                   "pop3s_client_certificate": {"required": False, "type": "str",
                                                                "choices": ["bypass",
                                                                            "inspect",
                                                                            "block"]},
                                   "smtps_client_certificate": {"required": False, "type": "str",
                                                                "choices": ["bypass",
                                                                            "inspect",
                                                                            "block"]},
                                   "ssl_other_client_certificate": {"required": False, "type": "str",
                                                                    "choices": ["bypass",
                                                                                "inspect",
                                                                                "block"]}
                               }},
