...
options:
    ...
    endpoint_control_fctems:
        ...
        suboptions:
            call_timeout:
                description:
                    - FortiClient EMS call timeout in milliseconds (500 - 50000 milliseconds).
                type: int
            certificate:
                description:
...
def filter_endpoint_control_fctems_data(json):
    option_list = ['call_timeout', 'certificate', 'cloud_server_type',
                   'fortinetone_cloud_authentication', 'https_port', 'name',
                   'pull_avatars', 'pull_sysinfo', 'pull_tags',
                   'pull_vulnerabilities', 'server', 'source_ip']
    dictionary = {}
...
def main():
    fields = {
        ...
        "endpoint_control_fctems": {
            ...
            "options": {
                "call_timeout": {"required": False, "type": "int"},
                "certificate": {"required": False, "type": "str"},
                "cloud_server_type": {"required": False, "type": "str",
                                      "choices": ["production",
                                                  "alpha",
                                                  "beta"]},
                "fortinetone_cloud_authentication": {"required": False, "type": "str",
                                                     "choices": ["enable",
                                                                 "disable"]},
                "https_port": {"required": False, "type": "int"},
                "name": {"required": True, "type": "str"},
                "pull_avatars": {"required": False, "type": "str",
                                 "choices": ["enable",
                                             "disable"]},
                "pull_sysinfo": {"required": False, "type": "str",
                                 "choices": ["enable",
                                             "disable"]},
                "pull_tags": {"required": False, "type": "str",
                              "choices": ["enable",
                                          "disable"]},
                "pull_vulnerabilities": {"required": False, "type": "str",
                                         "choices": ["enable",
                                                     "disable"]},
