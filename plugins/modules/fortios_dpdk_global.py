...
def main():
    fields = {
        ...
        "dpdk_global": {
            ...
            "options": {
                "elasticbuffer": {"required": False, "type": "str",
                                  "choices": ["disable",
                                              "enable"]},
                "hugepage_percentage": {"required": False, "type": "int"},
                "interface": {"required": False, "type": "list",
                              "options": {
                                  "interface_name": {"required": False, "type": "str"}
                              }},
                "mbufpool_percentage": {"required": False, "type": "int"},
                "multiqueue": {"required": False, "type": "str",
                               "choices": ["disable",
                                           "enable"]},
                "per_session_accounting": {"required": False, "type": "str",
                                           "choices": ["disable",
                                                       "traffic-log-only",
                                                       "enable"]},
                "sleep_on_idle": {"required": False, "type": "str",
                                  "choices": ["disable",
                                              "enable"]},
