            ...
            "options": {
                ...
                "neighbor": {"required": False, "type": "list",
                             "options": {
                                 ...
                                 "route_map_out_preferable": {"required": False, "type": "str"},
                                 "route_map_out6": {"required": False, "type": "str"},
                                 "route_map_out6_preferable": {"required": False, "type": "str"},
                ...
                "synchronization": {"required": False, "type": "str",
                                    "choices": ["enable",
                                                "disable"]},
                "vrf_leak": {"required": False, "type": "list",
                             "options": {
                                 "target": {"required": False, "type": "list",
                                            "options": {
                                                "interface": {"required": False, "type": "str"},
                                                "route_map": {"required": False, "type": "str"},
