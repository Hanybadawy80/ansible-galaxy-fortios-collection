...
def filter_user_nac_policy_data(json):
    option_list = ['category', 'description', 'family',
                   'host', 'hw_vendor', 'hw_version',
                   'mac', 'name', 'os',
                   'src', 'status', 'sw_version',
    ...
    fields = {
        ...
        "user_nac_policy": {
            ...
            "options": {
                ...
                "host": {"required": False, "type": "str"},
                "hw_vendor": {"required": False, "type": "str"},
                "hw_version": {"required": False, "type": "str"},
                ...
                "status": {"required": False, "type": "str",
                           "choices": ["enable",
                                       "disable"]},
                "sw_version": {"required": False, "type": "str"},
                "switch_auto_auth": {"required": False, "type": "str",
                                     "choices": ["global",
                                                 "disable",
                                                 "enable"]},
                "switch_fortilink": {"required": False, "type": "str"},
                "switch_mac_policy": {"required": False, "type": "str"},
                "switch_port_policy": {"required": False, "type": "str"},
                "switch_scope": {"required": False, "type": "list",
                                 "options": {
