...
def filter_log_fortianalyzer_cloud_setting_data(json):
    option_list = ['access_config', 'certificate', 'conn_timeout',
                   'enc_algorithm', 'hmac_algorithm', 'ips_archive',
                   'max_log_rate', 'monitor_failure_retry_period', 'monitor_keepalive_period',
