...
options:
    ...
    vpn_ipsec_phase1_interface:
        ...
        suboptions:
            ...
            fec_redundant:
                description:
                    - Number of redundant Forward Error Correction packets (0 - 100).
                type: int
            fec_send_timeout:
                description:
...
def filter_vpn_ipsec_phase1_interface_data(json):
    option_list = ['acct_verify', 'add_gw_route', 'add_route',
                   ...
                   'auto_discovery_sender', 'auto_negotiate', 'backup_gateway',
                   ...
                   'dhcp_ra_giaddr', 'dhcp6_ra_linkaddr', 'dhgrp',
                   'digital_signature_auth', 'distance', 'dns_mode',
                   'domain', 'dpd', 'dpd_retrycount',
                   'dpd_retryinterval', 'eap', 'eap_exclude_peergrp',
                   ...
                   'exchange_ip_addr4', 'exchange_ip_addr6', 'fec_base',
                   ...
                   'net_device', 'network_id', 'network_overlay',
        ...
        "vpn_ipsec_phase1_interface": {
            ...
            "options": {
                ...
                "add_route": {"required": False, "type": "str",
                              "choices": ["disable",
                                          "enable"]},
                "aggregate_member": {"required": False, "type": "str",
                                     "choices": ["enable",
                                                 "disable"]},
                "aggregate_weight": {"required": False, "type": "int"},
                ...
                "dhcp_ra_giaddr": {"required": False, "type": "str"},
                "dhcp6_ra_linkaddr": {"required": False, "type": "str"},
                ...
                "net_device": {"required": False, "type": "str",
                               "choices": ["enable",
                                           "disable"]},
                "network_id": {"required": False, "type": "int"},
