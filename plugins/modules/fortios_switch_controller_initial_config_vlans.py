...
def filter_switch_controller_initial_config_vlans_data(json):
    option_list = ['default_vlan', 'nac', 'quarantine',
                   'rspan', 'video', 'voice']
    dictionary = {}
...
def main():
    fields = {
        ...
        "switch_controller_initial_config_vlans": {
            ...
            "options": {
                "default_vlan": {"required": False, "type": "str"},
                "nac": {"required": False, "type": "str"},
                "quarantine": {"required": False, "type": "str"},
                "rspan": {"required": False, "type": "str"},
                "video": {"required": False, "type": "str"},
                "voice": {"required": False, "type": "str"}
