...
def filter_user_saml_data(json):
    option_list = ['cert', 'entity_id', 'group_name',
                   'idp_cert', 'idp_entity_id', 'idp_single_logout_url',
                   'idp_single_sign_on_url', 'name', 'single_logout_url',
                   'single_sign_on_url', 'user_name']
    dictionary = {}
