...
def filter_user_radius_data(json):
    option_list = ['accounting_server', 'acct_all_servers', 'acct_interim_interval',
                   ...
                   'group_override_attr_type', 'h3c_compatibility', 'name',
                   'nas_ip', 'password_encoding', 'password_renewal',
                   'radius_coa', 'radius_port', 'rsso',
                   'rsso_context_timeout', 'rsso_endpoint_attribute', 'rsso_endpoint_block_attribute',
                   'rsso_ep_one_ip_only', 'rsso_flush_ip_session', 'rsso_log_flags',
                   'rsso_log_period', 'rsso_radius_response', 'rsso_radius_server_port',
                   'rsso_secret', 'rsso_validate_request_secret', 'secondary_secret',
                   'secondary_server', 'secret', 'server',
                   'source_ip', 'sso_attribute', 'sso_attribute_key',
                   'sso_attribute_value_override', 'switch_controller_acct_fast_framedip_detect', 'tertiary_secret',
    ...
    fields = {
        ...
        "user_radius": {
            ...
            "options": {
                ...
                "group_override_attr_type": {"required": False, "type": "str",
                                             "choices": ["filter-Id",
                                                         "class"]},
                ...
                "sso_attribute_value_override": {"required": False, "type": "str",
                                                 "choices": ["enable",
                                                             "disable"]},
                "switch_controller_acct_fast_framedip_detect": {"required": False, "type": "int"},
